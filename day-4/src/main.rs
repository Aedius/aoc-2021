...
mod tests {
    ...
    fn test_calculate() {
        ...
        assert_eq!(container.calculate_1(), 4512);

        assert_eq!(container.calculate_2(), 1924);
    }
}
...
impl InputReader for Container {
    fn add_line(&mut self, line: &str) {
        ...
        match self.pos {
            ...
            Some(pos) => {
                let new_line_vec: Vec<usize> = line
                    .split(" ")
                    .into_iter()
                    .filter(|v| !v.is_empty())
                    .map(|v| v.parse::<usize>().unwrap())
                ...
                let new_line = new_line_vec.try_into().unwrap_or_else(|v: Vec<usize>| {
